					...
					<div class="widget-header">
						<div class="row">
							<div class="col-xl-12 col-md-12 col-sm-12 col-12">
								<h4>Edit Slider<a href="{{url('admin/slider')}}" class="btn btn-outline-danger" style="float: right;">Back</a></h4>
							</div>                                                                
						</div>
					</div>
					<div class="widget-content widget-content-area">
						...
						<form action="{{ url('admin/update-slider')  }}" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group mb-4">
								...
								<input type="text" class="form-control" name="title" placeholder="Please Enter Slider Title" required value="{{ $editSlider->title }}">
								@if ($errors->has('title'))
							...
							<div class="form-group mb-4">
								...
								<input type="text" class="form-control" name="website" placeholder="Website URL" value="{{ $editSlider->website }}" required>
							...
							<div class="form-group mb-4"> 
								<div class="custom-file-container" data-upload-id="myFirstImage">
									...
									<?php if(!empty($editSlider->image)){ ?> 
										<img src="{{asset($editSlider->image)}}" width="300px">
									<?php } ?>
