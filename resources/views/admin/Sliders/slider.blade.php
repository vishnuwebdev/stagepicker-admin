					...
					<div class="row">
						...
						<div class="col-xl-6 col-md-6 col-sm-6 col-6">
							<h4 style="float: right !important;">
								...
								<a href="{{url('admin/add-slider')}}" class="btn btn-primary">Create Slider</a>
								<?php } ?>
					...
					<div class="table-responsive mb-4">
						<table id="style-2" class="table style-2  table-hover">
							...
							<tbody>
								...
								<?php $intcount=1 ?>
								{{-- {{dd($slider)}} --}}
								@foreach($slider as $i=>$sliderdata)
								<tr>
									<td>{{$intcount}} </td>
									  
									<td>{{ $sliderdata->title }}</td>
									<td>{{ $sliderdata->website }}</td>
									...
									<td class="text-center">
											<ul class="table-controls">
												...
												<li>
													...
													<a href="{{url('admin/edit-slider')}}/{{ base64_encode($sliderdata->id) }}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
													<?php } ?>
												</li>
												<li>
													 <?php if($editPermission) { ?>
													<a onclick="return confirm('Are you sure want to delete this record?')" href="{{url('admin/slider-delete')}}/{{ base64_encode($sliderdata->id) }}" data-toggle="tooltip" data-placement="top" title="Delete"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2 text-danger"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></a>
                                                   <?php } ?>
												</li>
											</ul>
										</td>
