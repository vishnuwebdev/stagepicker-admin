						...
						<div class="col-xl-6 col-md-6 col-sm-6 col-6">
                                        <h4 style="float: right !important;">
                                        	<?php if($addPermission) { ?>
                                        	  <a href="{{ URL('admin/adminuser/add') }}" class="btn btn-primary">Create User</a>
                                            <?php } ?>
                                        </h4>
                                    </div>
					</div>
										...
										<ul class="table-controls">
											...
											<li>
												<?php
                                                  if($editPermission) {
												?>
												<a href="{{ url('admin/adminuser/edit',$userval->id)  }}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
												<?php } ?> 
											</li>
