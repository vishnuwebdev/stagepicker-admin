			...
			<div id="flFormsGrid" class="col-lg-12 layout-spacing">
				<div class="statbox widget box box-shadow">
					...
					<div class="widget-content widget-content-area">
						<form action="{{ url('admin/editAudition')  }}" method="POST" enctype="multipart/form-data">
							@csrf
							...
							<div class="row">
							    <div class="col-md-6">
							       <div class="form-group mb-4">
										...
										<input type="text" class="form-control" name="audition_title" id="audition_title" placeholder="Enter Title" value="{{ old('audition_title', isset($postaudition) ? $postaudition->audition_title : '') }}">
										@if ($errors->has('audition_title'))
											<span class="text-danger">{{ $errors->first('audition_title') }}</span>
										@endif
									</div> 
							   </div>
							   <div class="col-md-6">
							       <div class="form-group mb-4">
										...
										<input type="text" class="form-control" name="studio_name" id="studio_name" placeholder="Enter Studio Name" value="{{ old('studio_name', isset($postaudition) ? $postaudition->studio_name : '') }}">
										@if ($errors->has('studio_name'))
											<span class="text-danger">{{ $errors->first('studio_name') }}</span>
										@endif
									</div> 
							   </div>
							       ...
							       <div class="form-group mb-4">
										<label for="title">Union Type</label>
											...
											<select class="form-control" name="union_type">
												<option {{($postaudition->union_type == 1) ? 'selected' :' '}} value="1">Union</option>
												<option {{($postaudition->union_type == 0) ? 'selected' :' '}} value="0">Non-Union</option>
											</select>
					   ...
					   <?php } ?>
					    <div class="col-md-6">
							       <div class="form-group mb-4">
										...
										<div>
											<input type="radio" {{($postaudition->compensation == 1) ? 'checked' :' '}}  name="compensation" for="yes" value="1"> Yes
											<input type="radio" {{($postaudition->compensation == 0) ? 'checked' :' '}} name="compensation" for="no" value="0"> No
							    ...
							    <div class="col-md-12">
							       <div class="form-group mb-4">
										<label for="title">Compensation Description</label>
										    ...
										    <textarea  type="text" class="form-control" name="compensation_description" id="editor1"   rows="10" cols="80"> {{ $postaudition->compensation_description }}</textarea>
											
											@if ($errors->has('compensation_description'))
												<span class="text-danger">{{ $errors->first('compensation_description') }}</span>
											@endif
							   ...
							   <div class="col-md-6">
							       <div class="form-group mb-4">
										...
										<input type="date"  class="form-control" name="audition_date" id="audition_date" placeholder="Audition Date" value="{{date('Y-m-d',strtotime($postaudition->expire_date))}}">
										@if ($errors->has('audition_date'))
											<span class="text-danger">{{ $errors->first('audition_date') }}</span>
										@endif
									</div> 
							   </div>
							   <div class="col-md-6">
							       <div class="form-group mb-4">
										...
										<input type="time" class="form-control" name="audition_time" id="audition_time" placeholder="Audition Time" value="{{date('H:i',strtotime($postaudition->expire_date))}}">
										@if ($errors->has('audition_time'))
											<span class="text-danger">{{ $errors->first('audition_time') }}</span>
										@endif
									</div> 
							   </div>
							   <div class="col-md-6">
							       <div class="form-group mb-4">
										...
										<input type="text" class="form-control" name="location" id="location" placeholder="Location"value="{{ old('location', isset($postaudition) ? $postaudition->location : '') }}">
					   ...
					   <div class="col-md-12">
						   <div class="form-group mb-4">
								<label for="editor">Description</label>
								   <textarea  type="text" class="form-control" name="production_description" id="editor"   rows="10" cols="80"> {{ $postaudition->production_description }}</textarea>
				                     @if ($errors->has('production_description'))
				                     <span class="text-danger">{{ $errors->first('production_description') }}</span>
				                     @endif
							</div>
					   </div>	
					   <hr/>	
