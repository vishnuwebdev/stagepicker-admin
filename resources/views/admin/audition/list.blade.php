								...
								<?php foreach ($postaudition as $key => $postauditionval) { ?>
									...
									<td class="text-center">
										...
										<li>
											...
											<a href="{{ url('admin/auditiondetail') }}/<?php echo base64_encode($postauditionval->id); ?>" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-eye"></i> </a>
								          	
									</li>
									<li>
										<?php if($editPermission) { ?>
											<a href="{{ url('admin/postaudition') }}/edit/<?=$postauditionval->id?>" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i> </a>
									    <?php } ?>		
									</li>
								</ul>
									</td>
