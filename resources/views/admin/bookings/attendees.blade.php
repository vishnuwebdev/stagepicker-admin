                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                                        <h4>Attendees — {{ $class->title }}</h4>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                                        <h4 style="float: right !important;"><a href="{{ URL('admin/view-classes', $class->id) }}" class="btn btn-primary">Back to Class</a></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                                <p class="text-muted">
                                    Seats taken: {{ $seatsTaken }} / {{ $class->max_seats ?: 'Unlimited' }}
                                    (counts pending-payment + confirmed bookings)
                                </p>
                                <div class="table-responsive mb-4">
                                    <table id="style-2" class="table style-2 table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>#{{ $item->id }}</td>
                                                <td>{{ optional($users->get($item->user_id))->email ?: ('User #'.$item->user_id) }}</td>
