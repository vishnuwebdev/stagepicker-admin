            ...
            <div class="layout-px-spacing">
                <div class="row layout-top-spacing layout-spacing">
                    ...
                    <div class="widget-content widget-content-area">
                        <form action="{{url('admin/store-merchandise')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="size" placeholder="e.g. S, M, L, XL" value="{{ old('size') }}">
                        ...
                        <textarea type="text" class="ckeditor" name="description" id="editor1" rows="10" cols="80">{{ old('description') }}</textarea>
