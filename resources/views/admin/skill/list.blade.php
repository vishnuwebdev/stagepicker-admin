                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                                        <h4 style="float: right !important;">
                                            ...
                                            <a href="{{ URL('admin/add-skill') }}" class="btn btn-primary">Create Skill</a>
                                            <?php } ?>
                                        </h4>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive mb-4">
                                    <table id="style-2" class="table style-2  table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td> 1 </td>
                                                <td>{{ $skillval->skill_name }}</td>
                                                <td class="text-center">
                                                        <ul class="table-controls">
                                                            
                                                            <li>
                                                                <?php if($editPermission) { ?>
                                                                <a href="{{ url('admin/edit-skill',$skillval->id)  }}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                                <?php } ?>
                                                            </li> 
                                                            <li>
