							...
							<div class="row">
								<div class="col-md-2">
									...
									<div class="user-img"> 
										<?php if(!empty($userDetail->image)){ ?> 
											<img src="{{asset($userDetail->image)}}" width="100px">
										<?php }else{ ?>
								...
								<div class="col-md-10"> 
									<div class="profile-information">
									    <div class="row">
											...
											<p><strong>Stage Name : </strong>{{ $userDetail->stage_name }}</p>
										<?php } ?> 
									        </div>
									         <div class="col-md-6">
									           	<?php if($userDetail->user_type == 1){ ?>
										<p><strong>Age : </strong><?php if(!empty($userDetail->age)){ echo $userDetail->age; echo "Years old";  } ?></p>
									         ...
									         <div class="col-md-6">
									           <p><strong>Height : </strong>{{ $userDetail->height }}</p>
								...
								<div class="col-md-12">
									<div class="profile-information-right">
										...
										<p><strong>Role Type : </strong>{{ $userDetail->roles }}</p>
										...
										<?php  if($userDetail->user_type == 1){?>
											...
											<p><strong>Skills : </strong>{{ $userDetail->skills }}</p>
										<?php }  ?>
										...
										<p><strong>Producer Type : </strong>{{ $userDetail->producer_type }}</p>
										<?php } ?>
										...
										<p class="member-part"><strong>Instagram : </strong>{{ $userDetail->instagram }}</p>
										<p><strong>Facebook : </strong>{{ $userDetail->facebook }}</p>
										<p><strong>Tiktok : </strong>{{ $userDetail->tiktok }}</p>
										<p><strong>Snapchat : </strong>{{ $userDetail->snapchat }}</p>
										...
										<div class="row">
											<div class="col-md-3">
												<div class="headshots-img-part">
													...
													<img src="{{asset($portfolio['headshot_first'])}}">
													<?php }else{ ?>
													<div class="img-wrapper">
                                                    <a href="{{asset('public/assets/img/stagepicker-logo.png')}}"><img src="{{asset('public/assets/img/stagepicker-logo.png')}}" class="img-responsive"></a>
											...
											<div class="col-md-3">
												<div class="headshots-img-part">
													...
													<img src="{{asset($portfolio['headshot_second'])}}">
													<?php }else{ ?>
														<div class="img-wrapper">
                                                    <a href="{{asset('public/assets/img/stagepicker-logo.png')}}"><img src="{{asset('public/assets/img/stagepicker-logo.png')}}" class="img-responsive"></a>
                                                    <div class="img-overlay">
										...
										<div class="row">
											<div class="col-md-3">
												<div class="headshots-img-part">
													...
													<img src="{{asset($portfolio['headshot_third'])}}">
													<?php }else{ ?>
													<img src="{{asset('public/assets/img/stagepicker-logo.png')}}">
													<?php } ?>
												</div>
											...
											<div class="col-md-3">
												<div class="headshots-img-part">
													...
													<img src="{{asset($portfolio['headshot_fourth'])}}">
													<?php }else{ ?>
													<img src="{{asset('public/assets/img/stagepicker-logo.png')}}">
													<?php } ?>
												</div>
										...
										<div class="row">
											<div class="col-md-3 document-section">
												...
												<?php if(!empty($portfolio['document_first'])){ ?> 
													<a href="{{asset($portfolio['document_first'])}}" target="_blank">
													<div class="headshots-img-part">
											...
											<div class="col-md-3 document-section">
												 <?php if(!empty($portfolio['document_second'])){ ?>  
													<a href="{{asset($portfolio['document_second'])}}" target="_blank">
													<div class="headshots-img-part">
														<i class="fa fa-file-text" aria-hidden="true"></i>
													</div>
													</a>
										...
										<div class="row">
											<div class="col-md-3 document-section">
												<?php if(!empty($portfolio['audio_first'])){ ?> 
													...
													<a href="{{asset($portfolio['audio_first'])}}" target="_blank">
													<div class="headshots-img-part">
											...
											<div class="col-md-3 document-section">
												<?php if(!empty($portfolio['audio_second'])){ ?> 
													...
													<a href="{{asset($portfolio['audio_second'])}}" target="_blank">
													<div class="headshots-img-part">
														<i class="fa fa-music" aria-hidden="true"></i>
													</div>
													</a>
										...
										<div class="row">
											<div class="col-md-6 document-section">
												...
												?> 
													...
													<a href="{{asset($portfolio['video_first'])}}" target="_blank">
													<div class="headshots-img-part">
														<img
            ...
            width="150" />
											...
											<div class="col-md-6 document-section">
												...
												?> 
													...
													<a href="{{asset($portfolio['video_second'])}}" target="_blank">
														<div class="headshots-img-part">
															<img
