                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                                        <h4 style="float: right !important;"><a href="{{ URL('admin/add-webinars') }}" class="btn btn-primary">Create Webinars</a></h4>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                        <ul class="table-controls">
                                                            ...
                                                            <li><a href="{{ url('admin/edit-webinar',$categoryval->id)  }}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
</a></li>
                                                            <li>
                                                                ...
                                                                <li><a href="{{ url('admin/view-webinar',$categoryval->id)  }}" data-toggle="tooltip" data-placement="top" title="view"><i class="fa fa-eye" aria-hidden="true"></i>
</a></li>
                                                            </ul>
                                                    </td>
                                            </tr>
