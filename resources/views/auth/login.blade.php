...
<head>
    ...
    <link href="{{asset('public/assets/admin/css/main.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('public/assets/admin/css/authentication/form-2.css')}}" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="{{asset('public/assets/admin/css/forms/theme-checkbox-radio.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('public/assets/admin/css/forms/switches.css')}}">
    <style>
...
<body>
    ...
    <script src="{{asset('public/assets/admin/js/authentication/form-2.js')}}"></script>
</body>
</html>
