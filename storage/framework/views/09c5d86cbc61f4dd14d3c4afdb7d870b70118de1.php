...
<script src="<?php echo e(asset('public/assets/admin/js/libs/jquery-3.1.1.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/plugins/perfect-scrollbar/perfect-scrollbar.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/admin/js/app.js')); ?>"></script>
<script>
    $(document).ready(function() {
        App.init();
    });
</script>
<script src="<?php echo e(asset('public/assets/admin/js/scrollspyNav.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/plugins/table/datatable/datatables.js')); ?>"></script>
      <script>
		  ...
		  $(document).on("click",".pintop", function() {
			...
			var urldata = '<?php echo e(url("admin/audition-post-audition")); ?>';
			$.ajax({
				headers: {
		...
		$(document).on("click",".pintopcrew", function() {
			...
			var postAudId = $(this).attr('data-id'); 
			var urldata = '<?php echo e(url("admin/production-post-crew")); ?>';
			$.ajax({
				headers: {
					'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
				},
		...
		$(document).on("click",".updatestatus", function() {
			...
			var urldata = '<?php echo e(url("admin/update-user-status")); ?>';
			$.ajax({
				headers: {
					'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
				},
		...
		$(document).on("click",".updateauditionstatus", function() {
			...
			var urldata = '<?php echo e(url("admin/update-audition-status")); ?>';
			$.ajax({
				headers: {
					'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
				},
		...
		$(document).on("click",".updatecrewstatus", function() {
			...
			var Id = $(this).attr('data-id'); 
			var urldata = '<?php echo e(url("admin/update-crew-status")); ?>';
			$.ajax({
				headers: {
					'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
				},
        ...
        $(document).on('click', '.suspendSubmit', function () {
            ...
            var urldata = '<?php echo e(url("admin/usersuspend")); ?>';
			$.ajax({ 
				type: 'POST',
				dataType: "json",
				url: urldata, 
...
<?php /**PATH /Users/vishnusharma/StagePicker App/stagePicker/resources/views/admin/inc/scripts.blade.php ENDPATH**/ ?>