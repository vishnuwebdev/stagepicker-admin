                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                <div class="widget widget-one_hybrid widget-followers">
                                    <div class="widget-heading">
                                        ...
                                        <p class="w-value"><?php echo e(count($auditioners) + count($producer)); ?></p>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                <div class="widget widget-one_hybrid widget-referral">
                                    <div class="widget-heading">
                                        ...
                                        <p class="w-value"><?php echo e($activeauditioners); ?></p>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                <div class="widget widget-one_hybrid widget-engagement">
                                    <div class="widget-heading">
                                        ...
                                        <p class="w-value"><?php echo e($activeuserper); ?>%</p>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                <div class="widget widget-one_hybrid widget-followers">
                                    <div class="widget-heading">
                                        ...
                                        <p class="w-value"><?php echo e(count($auditioners)); ?></p>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                <div class="widget widget-one_hybrid widget-referral">
                                    <div class="widget-heading">
                                        ...
                                        <p class="w-value"><?php echo e(count($producer)); ?></p>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                <div class="widget widget-one_hybrid widget-engagement">
                                    <div class="widget-heading">
                                        ...
                                        <p class="w-value"><?php echo e($totalPostaudition); ?></p>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/vishnusharma/StagePicker App/stagePicker/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>