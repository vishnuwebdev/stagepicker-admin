			...
			<div id="flFormsGrid" class="col-lg-12 layout-spacing">
				<div class="statbox widget box box-shadow">
					<div class="widget-header">
						<div class="row">
							<div class="col-xl-12 col-md-12 col-sm-12 col-12">
								<h4>Create Slider<a href="<?php echo e(url('admin/slider')); ?>" class="btn btn-outline-danger" style="float: right;">Back</a></h4>
							</div>                                                                
						</div>
					</div>
					<div class="widget-content widget-content-area">
                        ...
                        <?php endif; ?>
						<form action="<?php echo e(url('admin/save-slider')); ?>" method="POST" enctype="multipart/form-data">
							<?php echo csrf_field(); ?>
							<div class="form-group mb-4">
								<label for="skill_name">Title</label>
								<input type="text" class="form-control" name="title" placeholder="Please Enter Slider Title" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/stagepicker/resources/views/admin/Sliders/add_slider.blade.php ENDPATH**/ ?>