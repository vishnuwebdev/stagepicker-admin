                ...
                <div class="row layout-top-spacing layout-spacing">
                    ...
                    <script src="//cdn.ckeditor.com/4.22.1/standard/ckeditor.js"></script>
                      ...
                      <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                        ...
                        <form action="<?php echo e(url('admin/store-weinars')); ?>" method="post" enctype = "multipart/form-data">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/vishnusharma/StagePicker App/stagePicker/resources/views/admin/webinar/add.blade.php ENDPATH**/ ?>