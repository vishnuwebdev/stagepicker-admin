							...
							<tbody>
								...
								<?php foreach ($postaudition as $key => $postauditionval) { ?>
									...
									<td class="text-center">
										...
										<!--</li>-->
										<li>
											<a href="<?php echo e(url('admin/crewdetail')); ?>/<?php echo base64_encode($postauditionval->id); ?>" data-toggle="tooltip" data-placement="top" title="Edit">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/stagepicker/resources/views/admin/audition/crewlist.blade.php ENDPATH**/ ?>