							...
							<div class="row">
							 <div class="col-md-12">
							  <div class="post-audition-details-part"> 
								<p><span>Title : </span> <?php echo e($detail->title); ?></p>
								<p><span>Category : </span> <?php if(!empty($detail->category_name)){ echo $detail->category_name; }else{ echo ""; } ?> </p>
								<p><span>Audition Date  : </span> <?php echo e($detail->expire_date); ?> </p> 
								<p><span>Location : </span> <?php echo e($detail->location); ?> </p>
								<p><span>Description : </span> <?php echo e($detail->description); ?> </p>
								<p><span>Skills :  </span> <?php echo e($detail->skills); ?> </p>
									  ...
									  <div class="card">
										...
										<div class="card-header" role="tab" id="headingOne<?= $key;?>">
										  <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne<?= $key;?>" aria-expanded="<?= $expand;?>"
											...
											<?php echo e($role->role_title); ?> | <?php echo e($role->category_name); ?><i class="fas fa-angle-down rotate-icon"></i> 
										  </a>
										</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/stagepicker/resources/views/admin/audition/crewdetail.blade.php ENDPATH**/ ?>